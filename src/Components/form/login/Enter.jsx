  ...
  return (
    <section className="flex flex-col p-4 mt-[20vh] max-w-full sm:max-w-lg animate-left">
      ...
      <>
        <Link
          to="/login/perdeu"
          className="inline-block text-[#666] w-max py-2 after:block after:h-[2px] after:w-full after:bg-current"
        >
          Perdeu a senha?
        </Link>
        <div className="mt-16">
          <h2 className="font-secondary text-3xl text-[#333] after:block after:h-2 after:w-12 after:bg-gray-300 after:rounded">
            Cadastre-se
          </h2>
          <p className="mt-8 mb-8">
            Ainda não possui conta? Cadastre-se no site.
          </p>
          <Link to="/login/criar" className="btn">
            Cadastro
          </Link>
        </div>
      </>
