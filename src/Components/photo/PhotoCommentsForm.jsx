...
const PhotoCommentsForm = ({ id, setComments, single }) => {
  ...
  return (
    ...
    >
      <textarea
        className="block text-base font-primary w-full bg-[#eee] border border-[#eee] p-2 outline-none rounded resize-none duration-200 focus:outline-none focus:border-[#fb1] focus:bg-white focus:shadow-[0_0_0_3px_#fea] hover:outline-none hover:border-[#fb1] hover:bg-white hover:shadow-[0_0_0_3px_#fea]"
        id="comment"
        name="comment"
        placeholder="Comente..."
        value={comment}
